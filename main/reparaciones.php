...
$sql = "SELECT c.cli_nom, c.cli_ape, c.cli_tel, r.rep_id, r.rep_imp, r.rep_mod, r.rep_serial, r.rep_diagnostico,  r.rep_costo, r.rep_date, r.trab_id, r.rep_dateF FROM reparaciones r INNER JOIN clientes c ON r.cli_id = c.cli_id WHERE r.rep_sta = 'e' OR rep_sta = 'b' AND r.rep_date LIKE '12-%' ORDER BY r.rep_id DESC";




/*SELECT c.cli_nom, c.cli_ape, c.cli_tel, r.rep_id, r.rep_imp, r.rep_mod, r.rep_serial, r.rep_diagnostico, r.rep_costo, r.rep_date, r.trab_id FROM reparaciones r INNER JOIN clientes c ON r.cli_id = c.cli_id WHERE r.rep_date LIKE '12-%' AND r.rep_sta = 'e' ORDER BY r.rep_id DESC; */
                    ...
                    <tbody>
                        ...
                        while ($res->fetch()) { ?>
                            ...
                            <tr>
                                ...
                                <td> $ <?php echo $costo;?>
                                <!--<form action="db/rep/modificar.php" method="POST">
                                        <input type="number" class="short" name="precio">
                                        <input type="number" value="<?php echo $rep_id?>" name="id" hidden>
                                ...
                                <form action="db/rep/modificarA.php" method="POST">
                                    <textarea name="diagnostico" id="" cols="5" rows="1"></textarea>
                                    <input type="number" value="<?php //echo $rep_id?>" name="id" hidden>
                                    <input type="submit" name="sendA" value="Modificar" id="">
                                </form>
                                </td>
                                <td> <?php //echo $garantia;?>
                                <form action="" meto></form>
                                <input type="checkbox" name="garantia[]" value="0" check><label>No</label><br/>
                                <input type="checkbox" name="garantia[]" value="1"><label>Si</label><br/>
                                <div class="action">
