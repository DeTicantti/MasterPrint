...
if ($_SESSION['nivel']== "1" || $_SESSION['nivel']=="2") {
    ...
    $sql = "SELECT cli_id, cli_nom, cli_ape, cli_tel FROM clientes ORDER BY cli_id DESC";
...
<table id="example" class="display" style="width:100%">
        ...
        <?php
                        ...
                        if ($res->num_rows>0) {
                            $res->bind_result($id,$nombre,$apellido,$telefono);
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $nombre. "  ";?>
                                    <a href="db/lib/insertar.php?i=<?php echo $id?>"><i class="fas fa-pencil-alt"></i></a>
                                </td>
                                <td>
                                    <?php echo $apellido;?>
                                </td>
                                ...
                                <div class="sucessmn ns">
                                    ...
                                    <a href="db/rep/nwrepar.php?nom=<?php echo $nombre?>&ape=<?php echo $apellido?>&i=<?php echo $id?>&te=<?php echo $telefono ?>"><i class="fas fa-xs fa-tools"></i></a>
                                </div>
                                <div class="te ns">
                                
                                <a href="db/rep/nwrepar.php?i=<?php echo $id?>"><i class="fas fa-list-alt"></i></a>
                                </div>
                                
                                <!--<div class="errormn ns">
                                    <a href="db/lib/borrar.php?id= ""><i class="fas fa-xs fa-trash-alt"></i></a>
